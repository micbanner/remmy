...
class __TwigTemplate_fe17e1378aaa64329d68b4628dcfd12d59fbb9283d359e3e52588f979c2df25b extends Twig_Template
{
    private $source;
...
<a href=\"";
        // line 5
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("size_new");
    ...
    <table class=\"table table-bordered\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["sizes"]) || array_key_exists("sizes", $context) ? $context["sizes"] : (function () { throw new Twig_Error_Runtime('Variable "sizes" does not exist.', 19, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["size"]) {
            ...
            echo "\">show</a>
                        ...
                        <li>
                            <a href=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("size_edit", ["idsize" => twig_get_attribute($this->env, $this->source, $context["size"], "idsize", [])]), "html", null, true);
            echo "\">edit</a>
                        </li>
                    </ul>
                </td>

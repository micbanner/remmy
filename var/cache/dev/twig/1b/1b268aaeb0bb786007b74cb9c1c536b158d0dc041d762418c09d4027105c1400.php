...
class __TwigTemplate_bb0f0e85919059402f431bc89b373bd03153acbbd710ad4d91b38c5b3cc94f0d extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute(($context["product"] ?? $this->getContext($context, "product")), "categoryCategoryIdcategory", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Idproduct</th>
                <td>";
        // line 30
        echo twig_escape_filter($this->env, $this->getAttribute(($context["product"] ?? $this->getContext($context, "product")), "idproduct", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("product_edit", array("idproduct" => $this->getAttribute(($context["product"] ?? $this->getContext($context, "product")), "idproduct", array()))), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
{% block body %}
    ...
    <table>
        <tbody>
            ...
            <tr>
                <th>Categorycategoryidcategory</th>
                <td>{{ product.categoryCategoryIdcategory }}</td>
            </tr>
            <tr>
                <th>Idproduct</th>

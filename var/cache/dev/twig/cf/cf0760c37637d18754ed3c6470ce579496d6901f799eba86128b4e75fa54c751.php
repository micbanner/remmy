...
class __TwigTemplate_2c9d1493ca2c0b60de71a55f9dfc783030ee79572f2d9259302870880a6f93e0 extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 14
        echo twig_escape_filter($this->env, $this->getAttribute(($context["category"] ?? $this->getContext($context, "category")), "idcategory", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("category_edit", array("idcategory" => $this->getAttribute(($context["category"] ?? $this->getContext($context, "category")), "idcategory", array()))), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";

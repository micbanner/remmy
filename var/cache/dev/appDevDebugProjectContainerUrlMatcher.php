...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/admin')) {
            if (0 === strpos($pathinfo, '/admin/stockproduct')) {
                ...
                if (preg_match('#^/admin/stockproduct/(?P<idstock>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'stockproduct_show')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\StockProductController::showAction',));
                }

                // stockproduct_edit
                if (preg_match('#^/admin/stockproduct/(?P<idstock>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'stockproduct_edit')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\StockProductController::editAction',));
                }

                // stockproduct_delete
                if (preg_match('#^/admin/stockproduct/(?P<idstock>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'stockproduct_delete')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\StockProductController::deleteAction',));
                }
            ...
            elseif (0 === strpos($pathinfo, '/admin/size')) {
                ...
                if (preg_match('#^/admin/size/(?P<idsize>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'size_show')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\SizeController::showAction',));
                }

                // size_edit
                if (preg_match('#^/admin/size/(?P<idsize>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'size_edit')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\SizeController::editAction',));
                }

                // size_delete
                if (preg_match('#^/admin/size/(?P<idsize>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'size_delete')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\SizeController::deleteAction',));
                }
            ...
            elseif (0 === strpos($pathinfo, '/admin/color')) {
                ...
                if (preg_match('#^/admin/color/(?P<idcolor>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'color_show')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\ColorController::showAction',));
                }

                // color_edit
                if (preg_match('#^/admin/color/(?P<idcolor>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'color_edit')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\ColorController::editAction',));
                }

                // color_delete
                if (preg_match('#^/admin/color/(?P<idcolor>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'color_delete')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\ColorController::deleteAction',));
                }
            ...
            elseif (0 === strpos($pathinfo, '/admin/category')) {
                ...
                if (preg_match('#^/admin/category/(?P<idcategory>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'category_show')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\CategoryController::showAction',));
                }

                // category_edit
                if (preg_match('#^/admin/category/(?P<idcategory>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'category_edit')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\CategoryController::editAction',));
                }

                // category_delete
                if (preg_match('#^/admin/category/(?P<idcategory>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'category_delete')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\CategoryController::deleteAction',));
                }
            ...
            elseif (0 === strpos($pathinfo, '/admin/product')) {
                ...
                if (preg_match('#^/admin/product/(?P<idproduct>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'product_show')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\ProductController::showAction',));
                }

                // product_edit
                if (preg_match('#^/admin/product/(?P<idproduct>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'product_edit')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\ProductController::editAction',));
                }

                // product_delete
                if (preg_match('#^/admin/product/(?P<idproduct>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'product_delete')), array (  '_controller' => 'Remmy\\BackOfficeBundle\\Controller\\ProductController::deleteAction',));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/user')) {
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_show')), array (  '_controller' => 'Remmy\\MainBundle\\Controller\\UserController::showAction',));
                    if (!in_array($canonicalMethod, array('GET'))) {
                        $allow = array_merge($allow, array('GET'));
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_edit')), array (  '_controller' => 'Remmy\\MainBundle\\Controller\\UserController::editAction',));
                    if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                        $allow = array_merge($allow, array('GET', 'POST'));
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_delete')), array (  '_controller' => 'Remmy\\MainBundle\\Controller\\UserController::deleteAction',));
        ...
        if ('/product' === $pathinfo) {
            return array (  '_controller' => 'RemmyFrontBundle:ProductRetail:Retail',  '_route' => 'front_product_retail',);
        }

 ...
 */
class Category extends \Remmy\BackOfficeBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Category' . "\0" . 'idcategory', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Category' . "\0" . 'categorycategory', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Category' . "\0" . 'idSize'];
        }

 ...
 */
class Product extends \Remmy\BackOfficeBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'image', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'price', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'categoryCategoryIdcategory', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'idproduct', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'categorycategory', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\Product' . "\0" . 'colorcolor'];
        }

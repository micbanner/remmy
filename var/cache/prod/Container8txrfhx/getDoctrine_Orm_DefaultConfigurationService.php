...
$b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Remmy\\BackOfficeBundle\\Resources\\config\\doctrine') => 'Remmy\\BackOfficeBundle\\Entity'));
$b->setGlobalBasename('mapping');

$a->addDriver($b, 'Remmy\\BackOfficeBundle\\Entity');
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\Remmy\\MainBundle\\Entity'))), 'Remmy\\MainBundle\\Entity');
...
$instance->setEntityNamespaces(array('RemmyBackOfficeBundle' => 'Remmy\\BackOfficeBundle\\Entity', 'RemmyMainBundle' => 'Remmy\\MainBundle\\Entity'));

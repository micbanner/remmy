 ...
 */
class InfosPayement extends \Remmy\BackOfficeBundle\Entity\backup\InfosPayement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\InfosPayement' . "\0" . 'idpayement', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\InfosPayement' . "\0" . 'typepayement', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\InfosPayement' . "\0" . 'cardnumber', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\InfosPayement' . "\0" . 'iduser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InfosPayement $proxy) {

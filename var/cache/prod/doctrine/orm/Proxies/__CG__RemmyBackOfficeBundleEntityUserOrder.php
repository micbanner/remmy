...
class UserOrder extends \Remmy\BackOfficeBundle\Entity\UserOrder implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'datestart', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'datestop', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'statut', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'quantitytotal', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'totalamount', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'taxes', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'idorder', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\UserOrder' . "\0" . 'iduser'];
        }

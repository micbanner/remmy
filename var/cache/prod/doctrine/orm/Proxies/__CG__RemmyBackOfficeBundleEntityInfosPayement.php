...
class InfosPayement extends \Remmy\BackOfficeBundle\Entity\InfosPayement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\InfosPayement' . "\0" . 'typepayement', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\InfosPayement' . "\0" . 'cardnumber', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\InfosPayement' . "\0" . 'idpayement', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\InfosPayement' . "\0" . 'iduser'];
        }

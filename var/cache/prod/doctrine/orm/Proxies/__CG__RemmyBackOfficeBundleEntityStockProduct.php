 ...
 */
class StockProduct extends \Remmy\BackOfficeBundle\Entity\StockProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\StockProduct' . "\0" . 'quantity', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\StockProduct' . "\0" . 'idstock', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\StockProduct' . "\0" . 'idproduct', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\StockProduct' . "\0" . 'idcolor', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\StockProduct' . "\0" . 'idsize'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StockProduct $proxy) {

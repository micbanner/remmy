 ...
 */
class Product extends \Remmy\BackOfficeBundle\Entity\backup\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'idproduct', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'name', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'description', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'image', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'price', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'categoryCategoryIdcategory', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'categorycategory', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'colorcolor', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\backup\\Product' . "\0" . 'stockstock'];
        }
    ...
    public function setCategoryCategoryIdcategory($categoryCategoryIdcategory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategoryCategoryIdcategory', [$categoryCategoryIdcategory]);

        return parent::setCategoryCategoryIdcategory($categoryCategoryIdcategory);
    }
    ...
    public function getCategoryCategoryIdcategory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCategoryCategoryIdcategory', []);

        return parent::getCategoryCategoryIdcategory();
    }
    ...
    public function setCategorycategory(\Remmy\BackOfficeBundle\Entity\Category $categorycategory = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategorycategory', [$categorycategory]);

        return parent::setCategorycategory($categorycategory);
    }

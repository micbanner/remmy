 ...
 */
class ProductStock extends \Remmy\BackOfficeBundle\Entity\ProductStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\ProductStock' . "\0" . 'idstock', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\ProductStock' . "\0" . 'quantity', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\ProductStock' . "\0" . 'idcolor', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\ProductStock' . "\0" . 'idsize', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\ProductStock' . "\0" . 'productstock'];
        }

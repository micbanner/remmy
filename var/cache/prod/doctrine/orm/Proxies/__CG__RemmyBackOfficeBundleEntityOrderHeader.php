 ...
 */
class OrderHeader extends \Remmy\BackOfficeBundle\Entity\OrderHeader implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\OrderHeader' . "\0" . 'idorder', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\OrderHeader' . "\0" . 'creationdate', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\OrderHeader' . "\0" . 'lastUpdate', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\OrderHeader' . "\0" . 'iduser', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\OrderHeader' . "\0" . 'statut'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderHeader $proxy) {

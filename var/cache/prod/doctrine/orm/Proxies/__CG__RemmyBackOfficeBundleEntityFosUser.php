...
class FosUser extends \Remmy\BackOfficeBundle\Entity\FosUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'username', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'usernameCanonical', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'email', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'emailCanonical', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'enabled', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'salt', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'password', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'lastLogin', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'confirmationToken', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'passwordRequestedAt', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'roles', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'gender', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'firstname', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'lastname', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'address', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'zipCode', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'city', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'country', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'phone', '' . "\0" . 'Remmy\\BackOfficeBundle\\Entity\\FosUser' . "\0" . 'id'];
        }
